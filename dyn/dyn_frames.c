...
#include "../../PENE/hal_dyn_uart/hal_dyn_uart_emu.h"
#include "../../PENE/hal_dyn_uart/fake_msp.h"
#include <stdio.h>
...
struct RxReturn RxPacket(void) {
	...
	//anem a comprovar que el checksum mes la suma de tots els bytes del paquet més el checksum doni 0xFF.
